          ...
          child: GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: Theme.of(context).colorScheme.switcherBorder,
                  ),
                  BoxShadow(
              ...
              child: Stack(
                children: <Widget>[
                  Container(
                    child: Align(
                      alignment: _toggleAnimation.value as AlignmentGeometry,
                      child: Container(
                        width: widget.toggleSize,
                        height: widget.toggleSize,
                        decoration: BoxDecoration(
                          shape: BoxShape.circle,
                          color: Theme.of(context).colorScheme.switcherToggle,
                          border: _toggleBorder,
                        ),
                      ),
                    ),
                  ...
                  Positioned(
                    left: 5,
                    top: (widget.height - widget.activeIcon!.size!) / 2,
